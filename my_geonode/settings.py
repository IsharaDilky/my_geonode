...
from my_geonode import get_version
from my_geonode.celeryapp import app  # flake8: noqa
import djcelery
...
SECRET_KEY = os.getenv('SECRET_KEY', "%1wvo#u6*kutw^kn_sk2%0j66^42&-es0e(=rz*2@+oy(@7uji")
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'my_geonode Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, my_geonode',
